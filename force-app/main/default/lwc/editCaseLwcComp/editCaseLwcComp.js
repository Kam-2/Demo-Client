...
export default class NewCaseLwcComp extends NavigationMixin(LightningElement) {
    ...
    @wire(getObjectFields, { objectName: 'Case', fieldSet_Name:'Edit Case Information'}) //New_Case_Information
 ...
 if((this.pickvaue != '')){
    ...
    onSubmitHandler(event) {
        ...
        console.log('js' + fields.Service_Request_Type__c);
